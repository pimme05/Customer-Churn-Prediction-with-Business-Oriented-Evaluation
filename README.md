...
Model scoring outputs are operationalized in an interactive Power BI dashboard designed for monitoring churn risk and business impact.

The dashboard enables stakeholders to:
- Track overall churn rate and expected monthly revenue loss
- Identify high-risk customer segments based on behavioral drivers
- Compare churn patterns across age groups, payment behavior, and geography
- Support prioritization of retention actions under capacity constraints

![Power BI Dashboard Overview](dashboards/screenshots/overview.png)

The dashboard consumes customer-level outputs generated by the model, including churn probability, risk tier, and expected revenue loss, enabling actionable decision-making beyond offline model evaluation.
